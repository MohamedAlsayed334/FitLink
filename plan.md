...
│   ├── src/
│   │   ├── config/         # db.js, env.js
│   │   ├── models/         # User, Package, GymSubscription, CoachSubscription, Rating, Interaction
│   │   ├── controllers/
│   │   ├── routes/
│   │   ├── middleware/      # auth.js, role.js, errorHandler.js
│   │   ├── services/        # business logic (e.g. one-coach-rule, pricing calc)
│   │   ├── utils/
│   │   └── app.js
│   ├── server.js
│   ├── .env.example
